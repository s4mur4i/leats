...
our $hint="Server has problems booting. The grub.conf is missing.\nWe should boot the servers with parameters and try to replace the file.\nhttp://wiki.centos.org/HowTos/GrubInstallation\n";
#
#
#
#############
...
sub break() {
	...
	unlink "/mentes/boot/grub/grub.conf";
	Framework::umount;
	Framework::start;
